// DarkVeil Background - vanilla JavaScript WebGL implementation
class DarkVeilBackground {
    constructor(container, options = {}) {
        this.container = container;
        this.options = {
            hueShift: options.hueShift || 0,
            noiseIntensity: options.noiseIntensity || 0.02,
            scanlineIntensity: options.scanlineIntensity || 0.05,
            speed: options.speed || 0.3,
            scanlineFrequency: options.scanlineFrequency || 0.02,
            warpAmount: options.warpAmount || 0.1,
            resolutionScale: options.resolutionScale || 0.8,
            ...options
        };
    ...
    render() {
        const currentTime = ((performance.now() - this.startTime) / 1000) * this.options.speed;
...
// Export for use
window.DarkVeilBackground = DarkVeilBackground;